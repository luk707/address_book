...
class ContactView extends React.Component<ContactViewProps, ContactViewState> {
  ...
  render() {
    return (
      ...
      <Toolbar back={{icon:"chevron_left", label:"Contacts"}} title={`${this.props.contact.name.given} ${this.props.contact.name.family}`}/>
      <Content>
        <div className="heading">
          <img src={Gravatar.url(this.props.contact.email, {
